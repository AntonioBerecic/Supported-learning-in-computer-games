...
def evaluate(episodes=100, visualize_first_n=2):
    ...
    # Render mode for first few episodes
    env_render = gym.make(ENV_NAME, render_mode="human")
    # Regular env for fast eval
    ...
    for episode in range(episodes):
        ...
        while not done:
            if episode < visualize_first_n:
                time.sleep(0.015)  # kontroliraj brzinu prikaza
    ...
    print("\n--- Evaluacija modela DQN na CartPole-v1 ---")
